  ...
  async updateStatus(req) {
    ...
    try {
      ...
      if (status === 'CANCELLED') {
        ...
        msg = `Your order was cancelled due to ${reason.toUpperCase()}. We sincerely apologize for any inconvenience and will call you soon on ${phone} with further details.
